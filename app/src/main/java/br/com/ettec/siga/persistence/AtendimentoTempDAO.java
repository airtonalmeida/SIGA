 ...
 */
public class AtendimentoTempDAO extends SQLiteOpenHelper {

    private static final String TABELA = "atendimentostemp";

    private static final int VERSION = 1;

    public AtendimentoTempDAO(Context context) {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + AtendimentoTempDAO.TABELA);
        this.onCreate(db);
