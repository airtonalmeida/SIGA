...
/**
 * Created by Tom on 15/09/2016.
 */
public class AtendimentoIniciarTempDAO extends SQLiteOpenHelper {

    private static final String TABELA = "atendimentosiniciartemp";

    private static final int VERSION = 1;

    public AtendimentoIniciarTempDAO(Context context) {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + AtendimentoIniciarTempDAO.TABELA);
        this.onCreate(db);
